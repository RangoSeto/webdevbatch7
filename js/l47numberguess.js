...
getbtn.addEventListener('click',function(){
	...
	if(guess === winningnum){
		...
		if(gameleft === 0){
			...
			// message 1
			// message1.innerText = `${guess} is not correct, ${gameleft} game left`;
			// message1.style.color = "blue";

			setmessage1(`${guess} is not correct, ${gameleft} game left`,"blue");
